...
Tax laws are complex and change frequently. This overview covers key concepts. Work with a tax professional familiar with real estate to optimize your specific situation.
...
<AccordionGroup>
  ...
  <Accordion title="$25,000 allowance">
    Taxpayers who actively participate in rental activities can deduct up to 100,000 and \$150,000. \$25,000 in rental losses against non-passive income. This phases out for adjusted gross income between 
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="Tax Implications of Selling" icon="receipt" href="/service-categories/accountants-tax/tax-implications-selling">
    Understanding taxes when selling property
  </Card>
