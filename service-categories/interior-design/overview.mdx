...
<CardGroup cols={2}>
  <Card title="Types of Services" icon="list" href="/service-categories/staging-interior-design/interior-design/types-of-services">
    Full-service design, consultation, e-design, and specialty services
  </Card>
  <Card title="The Design Process" icon="clipboard-check" href="/service-categories/staging-interior-design/interior-design/the-design-process">
    What happens from initial meeting to completed project
  </Card>
  <Card title="Costs and Fees" icon="dollar-sign" href="/service-categories/staging-interior-design/interior-design/costs-and-fees">
    How designers charge and what to expect
  </Card>
  <Card title="Comparing Designers" icon="magnifying-glass" href="/service-categories/staging-interior-design/interior-design/comparing-designers">
