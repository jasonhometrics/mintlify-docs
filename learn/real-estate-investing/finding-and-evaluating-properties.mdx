...
<AccordionGroup>
  ...
  <Accordion title="Verify existing rents">
    ...
    - Request copies of current [leases](/service-categories/legal/rentals/lease-agreements)
...
<Steps>
  ...
  <Step title="Rent verification">
    For occupied properties, verify current [leases](/service-categories/legal/rentals/lease-agreements), payment history, and security deposits. Request estoppel certificates from tenants confirming lease terms.
  </Step>
