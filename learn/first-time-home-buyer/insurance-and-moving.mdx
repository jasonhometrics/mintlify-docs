...
<AccordionGroup>
  <Accordion title="Valuation coverage">
    Moving companies offer two levels of [liability protection](/service-categories/movers/protecting-your-belongings):
...
<CardGroup cols={2}>
  <Card title="Moving Companies Overview" icon="truck-moving" href="/service-categories/movers/overview">
    Understanding moving services and options
  </Card>
  <Card title="Getting Estimates" icon="file-invoice-dollar" href="/service-categories/movers/getting-estimates">
    How to get accurate quotes and compare
  </Card>
  <Card title="Protecting Your Belongings" icon="shield" href="/service-categories/movers/protecting-your-belongings">
    Valuation coverage, documentation, and claims
  </Card>
  <Card title="Costs and Pricing" icon="dollar-sign" href="/service-categories/movers/costs-and-pricing">
    How pricing works and what affects your cost
  </Card>
</CardGroup>

<CardGroup cols={2}>
  <Card title="Avoiding Scams" icon="triangle-exclamation" href="/service-categories/movers/avoiding-scams">
    Red flags and how to protect yourself
  </Card>
  <Card title="Comparing Movers" icon="scale-balanced" href="/service-categories/movers/comparing-movers">
    Questions to ask and evaluation criteria
  </Card>
</CardGroup>
