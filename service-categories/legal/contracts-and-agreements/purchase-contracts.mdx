...
**As-is sales:** Seller makes no warranties about condition. Buyer accepts property in current state. Does not eliminate disclosure obligations for known defects.

**Walk-through rights:** Typically within 24-48 hours of closing to verify:
...
**State association forms:** Most states have standard forms created by realtor associations. These are widely used and familiar to all parties.

**Attorney-prepared forms:** Some states use attorney-drafted forms, particularly in attorney-required closing states.

**Builder contracts:** New construction typically uses builder-prepared contracts that favor the builder. Review carefully.

**FSBO forms:** For sale by owner transactions may use various forms. Quality and balance vary significantly.
