...
<AccordionGroup>
  ...
  <Accordion title="Professional property management">
    ...
    **Services typically include:**
    ...
    - Lease enforcement
    - [Eviction](/service-categories/legal/landlord-tenant/eviction-process) processing
    - Financial reporting
...
<AccordionGroup>
  ...
  <Accordion title="Due dates and grace periods">
    Most leases specify rent due on the 1st with a grace period (often 3-5 days) before late fees apply. Be consistent in applying the [lease](/service-categories/legal/landlord-tenant/lease-agreements) terms.
  </Accordion>
  ...
  <Accordion title="Non-payment response">
    ...
    4. Begin [eviction process](/service-categories/legal/landlord-tenant/eviction-process) if not resolved
...
<AccordionGroup>
  ...
  <Accordion title="Move-out inspection">
    Document condition at move-out, comparing to move-in inspection. Identify damage beyond normal wear and tear for [security deposit](/service-categories/legal/landlord-tenant/security-deposits) deductions.
  </Accordion>
