...
**Reasonable accommodations:** Landlords and HOAs must make reasonable exceptions to rules, policies, or practices when necessary for a person with a disability to use and enjoy housing.
...
**Reasonable modifications:** Tenants with disabilities can make reasonable physical modifications to units and common areas at their own expense.
...
**Accessibility requirements:** Buildings with 4\+ units built after March 1991 must meet accessibility standards:
...
**Department of Housing and Urban Development (HUD)** Primary enforcement agency for Fair Housing violations.

Website: hud.gov/fairhousing Phone: 1-800-669-9777
...
**State and local agencies:** Many states have fair housing agencies that can also investigate complaints. Some have additional protections beyond federal law.
