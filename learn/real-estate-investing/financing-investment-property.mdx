...
Investment property financing differs from primary residence mortgages. Lenders view investment properties as higher risk, resulting in stricter requirements, larger down payments, and higher interest rates.
...
<CardGroup cols={2}>
  ...
  <Card title="Loan Types" icon="file-invoice-dollar" href="/service-categories/mortgage-lenders/loan-types">
    Detailed guide to mortgage options
  </Card>
  <Card title="Comparing Lenders" icon="magnifying-glass" href="/service-categories/mortgage-lenders/comparing-lenders">
