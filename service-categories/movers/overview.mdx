...
<CardGroup cols={2}>
  <Card title="Types of Moves" icon="truck" href="/service-categories/movers/types-of-moves">
    Local, long-distance, interstate, and specialty moving
  </Card>
  <Card title="Getting Estimates" icon="calculator" href="/service-categories/movers/getting-estimates">
    In-home surveys, virtual estimates, and binding quotes
  </Card>
  <Card title="The Moving Process" icon="boxes-stacked" href="/service-categories/movers/the-moving-process">
  ...
  <Card title="Comparing Movers" icon="magnifying-glass" href="/service-categories/movers/comparing-movers">
