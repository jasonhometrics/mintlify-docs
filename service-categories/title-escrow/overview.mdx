...
<CardGroup cols={3}>
  ...
  <Card title="Accuracy" icon="magnifying-glass">
    Thorough research uncovers ownership problems before closing. Missed issues create legal and financial burdens after transfer.
  </Card>
  
  <Card title="Settlement Agents" icon="file-signature">
    Licensed settlement agents can explain documents and answer questions during closing. Notaries witness signatures without providing guidance.
  </Card>
</CardGroup>
