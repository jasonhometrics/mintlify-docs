...
<AccordionGroup>
  ...
  <Accordion title="Per-form pricing">
    ...
    **Pros:** Pay for what you need <br /><br />**Cons:** Hard to predict total cost in advance
  ...
  <Accordion title="Hourly billing">
    ...
    **Pros:** Pay only for actual work<br /><br />**Cons:** Unpredictable costs, may hesitate to ask questions
  ...
  <Accordion title="Value pricing">
    ...
    **Pros:** Aligned incentives, includes planning <br /><br />**Cons:** May be higher than hourly for simple situations
