...
<AccordionGroup>
  ...
  <Accordion title="Professional property management">
    Property managers handle day-to-day operations for a fee, typically 8-12% of monthly rent plus leasing fees for new tenants.
...
<Warning>
  Notify your insurance company when converting to rental. Claims may be denied if the property is rented under a standard homeowners policy.
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card title="Landlord Rights" icon="scale-balanced" href="/service-categories/legal/rentals/landlord-rights">
    Legal guide for property owners
  </Card>
  <Card title="Comparing Insurance" icon="shield-halved" href="/service-categories/homeowners-insurance/comparing-insurance">
