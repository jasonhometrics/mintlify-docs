...
Most investors also need to understand [landlord-tenant law](/service-categories/legal/rentals/overview), lease agreements, and their rights and responsibilities as property owners. Legal missteps create liability and financial loss.
...
<AccordionGroup>
  <Accordion title="Personal ownership (sole proprietorship)">
    ...
    **Advantages:**
    ...
    - Easier [financing](/service-categories/mortgage-lenders/overview) (conventional loans)
...
- Maintain adequate [insurance](/service-categories/homeowners-insurance/overview)
...
<Note>
  Some investors hold properties in personal name for financing purposes, then transfer to an LLC after closing. This may trigger due-on-sale clauses in mortgages, though lenders rarely enforce them for transfers to single-member LLCs. Consult with an [attorney](/service-categories/legal/real-estate-attorneys/overview) before transferring.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Fair housing compliance">
    Federal [Fair Housing Act](/service-categories/legal/consumer-protections/fair-housing) prohibits discrimination based on race, color, religion, national origin, sex, familial status, or disability. State and local laws may add protected classes.
...
<AccordionGroup>
  <Accordion title="Collect rent">
    Landlords have the right to collect rent as specified in the [lease](/service-categories/legal/rentals/lease-agreements) and pursue legal remedies for non-payment, including late fees, notices, and eviction.
  </Accordion>
  ...
  <Accordion title="Evict for cause">
    Landlords can pursue [eviction](/service-categories/legal/rentals/eviction-process) for non-payment, lease violations, or other legal grounds following proper procedures.
  </Accordion>
...
The [lease](/service-categories/legal/rentals/lease-agreements) is the foundational legal document governing the landlord-tenant relationship.
...
<Note>
  Use state-specific lease forms or have an [attorney](/service-categories/legal/real-estate-attorneys/overview) review your lease. Provisions that violate state law may be unenforceable and create liability.
</Note>

## Eviction Process

When tenants violate the lease or fail to pay rent, landlords must follow legal [eviction procedures](/service-categories/legal/rentals/eviction-process).
...
<Card title="Next: Managing Your Investment" icon="arrow-right" href="/learn/real-estate-investing/managing-your-investment">
